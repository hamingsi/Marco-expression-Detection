...
transform = transforms.Compose(
    transforms=[transforms.ToPILImage(), transforms.ToTensor(), transforms.Normalize(mean=[0.485, 0.456, 0.406],
...
def get_emo_model():
    ...
    model_path = 'e:/microemotion/DDAMFN-main/DDAMFN2/checkpoints_ver2.0/affecnet7_epoch19_acc0.671.pth'
...
class RMN:
    ...
    def detect_emotion_for_single_face_image(self, face_image):
        ...
        out,feat,heads = self.emo_model(face_image)
