...
model_name = {
    'resnet18': 'OpenGprahAU-ResNet18_first_stage.pth',
    'resnet34': 'resnet34-333f7ec4.pth',
    'resnet50': 'OpenGprahAU-ResNet50_first_stage.pth',
...
def resnet18(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        load_state_dict(model, os.path.join(models_dir, model_name['resnet18']))
    return model
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        load_state_dict(model, os.path.join(models_dir, model_name['resnet50']))
    return model
